 ...
 * @author wdani
 */
public class ShellSortAscendente implements Runnable {
    ...
    public ShellSortAscendente(GraficaOrdenada pantalla, String datos, String titulos, String nombre, int velocidad, JLabel pasos, Thread t2, JPanel grafico, JLabel tiempo, JLabel vel, JLabel orden) {
        this.datos = datos;
    ...
    public void run() {
        ...
        generarReporte("Reporte ShellSort Ascendente", "ReporteShellAscendente", datosFinal, datosInicial, titulosFinal);
    }
    ...
    private void generarReporte(String titulo, String ruta, String ultimos[][], String inicio[][], String titulos[]) {
        ...
        String html = "<html>\n"
                ...
                + datosFinal
                + "</tr></table>\n"
                + "<center><img src=\"../Imagenes/GraficaShellAscendente.png\" width=\"80%\" height=\"600px\"></center>"
                + "\n</body>\n"
                + "</html>";
                ...
                for (i = salto; i < datosFinal.length; i++) {
                    if (Integer.parseInt(datosFinal[i - salto][1]) > Integer.parseInt(datosFinal[i][1])) {
                        ...
                        try {
                            ...
                            try {
                                OutputStream crearImagen = new FileOutputStream("Imagenes/GraficaShellAscendente.png") {
                                };
