 ...
 * @author wdani
 */
public class QuickSortAscendente implements Runnable {
    ...
    public QuickSortAscendente(GraficaOrdenada pantalla, String datos, String titulos, String nombre, int velocidad, JLabel pasos, Thread t2, JPanel grafico, JLabel tiempo, JLabel vel, JLabel orden) {
        this.datos = datos;
    ...
    public void run() {
        ...
        generarReporte("Reporte QuickSort Ascendente", "ReporteQuickAscendente", datosFinal, datosInicial, titulosFinal);
    }
    ...
    private void generarReporte(String titulo, String ruta, String ultimos[][], String inicio[][], String titulos[]) {
        ...
        String html = "<html>\n"
                ...
                + datosFinal
                + "</tr></table>\n"
                + "<center><img src=\"../Imagenes/GraficaQuickAscendente.png\" width=\"80%\" height=\"600px\"></center>"
                + "\n</body>\n"
                + "</html>";
    ...
    public void quickSort(String datosFinal[][], int izquierda, int derecha, int pasos, String titulosFinal[]) {
        ...
        try {
            ...
            try {
                OutputStream crearImagen = new FileOutputStream("Imagenes/GraficaQuickAscendente.png") {
                };
